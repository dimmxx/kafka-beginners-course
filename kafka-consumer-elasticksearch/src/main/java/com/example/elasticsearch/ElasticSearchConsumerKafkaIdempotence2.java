...
public class ElasticSearchConsumerKafkaIdempotence2 {

    private static Logger logger = LoggerFactory.getLogger(ElasticSearchConsumerKafkaIdempotence2.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : consumerRecords) {
                ...
                String id = parseJsonValue(record.value());
